...
HOOK @ $80016dd4
{
    ...
    word 0x79b00    # \ 					# Normally 99B00
    word 0x4Cb900   # | Menu Instance sizes	# Normally 4EB90
    word 0x393400   # /						# Normally 3B3400
...
_loadModule:
    ...
    addi r5, r31, 0x18		# "sy_core.rel"
    li r6, 0x3C				# Syringe heap
    li r7, 1
    li r8, 0
    lis r12, 0x8002
    ori r12, r12, 0x6E00
